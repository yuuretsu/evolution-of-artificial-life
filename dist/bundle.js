...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getNarrowImg = exports.drawLastAction = exports.drawFamilies = exports.drawAbilities = exports.drawEnergy = exports.drawColors = void 0;
...
function updateImage(world, mode, options, drawBotsNarrow) {
    switch (mode) {
        ...
        case 'energy':
            world.clearImage();
            world.visualize(view_modes_1.drawEnergy);
            break;
        case 'families':
            world.clearImage();
...
window.addEventListener('load', function () {
    var _a, _b, _c;
    onResizeWindow();
    var $inputFps = document.querySelector('#input-fps');
    document.querySelectorAll('#input-width, #input-height, #input-pixel, #input-fps').forEach(function (elem) {
        elem.addEventListener('change', function (event) {
            var target = event.target;
            target.value = math_functions_1.limNumber(parseInt(target.min), parseInt(target.max), parseInt(target.value)).toString();
        });
    });
